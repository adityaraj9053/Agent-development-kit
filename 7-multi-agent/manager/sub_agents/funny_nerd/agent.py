...
from google.adk.tools.tool_context import ToolContext # It is a specialized context object provided to our tool functions,
# enabling them to interact with the agent's runtime environment. It serves as a bridge between your tool's logic and the
# broader agent infrastructure, offering access to session state, artifact management, authentication mechanisms, and
# more
...
def get_nerd_joke(topic: str, tool_context: ToolContext) -> dict:
    ...
    # It is important because our tool can refer back to the last joke topic later—useful for follow-up questions like
    # "Tell me another one" or "Something different from last time."
